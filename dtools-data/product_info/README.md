...
```text
dtools-data/product_info/<product-id>_info.json
```

Example:

```text
dtools-data/product_info/8e1b0c2d-1234-5678-9012-abcdefabcdef_info.json
```
...
```text
dtools-data/product_info/manifest.json
```
...
1. save it in `dtools-data/product_info/<product-id>_info.json`
2. update `dtools-data/product_info/manifest.json` with the mapping
