...
File:
- `skills/d-tools-skill/scripts/generate_quote_html.js`
...
node skills/d-tools-skill/scripts/generate_quote_html.js --quote-id db2358ca-c410-4678-bb84-3a60717f28f2
```
