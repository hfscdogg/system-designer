...
function getManifestPath(baseDir = "product_info") {
...
function getProductExtraInfoPath(productId, baseDir = "product_info") {
  return path.resolve(baseDir, `${sanitizeForFilename(productId)}_info.json`);
}

function readManifest(baseDir = "product_info") {
...
function ensureManifestEntry(productId, baseDir = "product_info") {
...
function saveProductExtraInfo(productId, data, options = {}) {
  const baseDir = options.baseDir || "product_info";
